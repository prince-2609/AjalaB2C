...
public class B2cCheckoutPage {
	public static void GuestAdultCheckoutForFlight(String adult, String AdultTitle, String AdultName, String AdultDate,
		...
		for (int i = 1; i <= adt; i++) {
			...
			String text3 = "/html/body/div[4]/div/div[2]/div/div/select[2]";
			QaRobot.selectTextByLocator1(text3, Year1, "<b><i>Select Passport year for adult</i></b>");
			Thread.sleep(2000);
			String text2 = "/html/body/div[4]/div/div[2]/div/div/select[1]";
	...
	public static void GuestAdultCheckoutForHotel(String Emailid, String Adult, String AdultTitle, String AdultName,
		...
		for (int i = 1; i <= adtTotal; i++) {
			...
			String PhoneSelection[] = Phone.split(",");
//			String PhoneS[] = PhoneSelection[i - 1].split(" ");

			String adultPhoneElement = "(//input[contains(@id,'ctl00_contentMain_txt_phoneAdt_H')])[" + i + "]";
			QaRobot.PassValueByLocator(adultPhoneElement, PhoneSelection[i - 1],
					"<b><i>Write Phone Number For Adult</i></b>");
		}
