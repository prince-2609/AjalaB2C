...
public class B2cTripType {
	...
	public static void flightTriptype(String TripType, String Trip, String OriginCityCode, String OriginLocation,
		...
		if (TripType.equalsIgnoreCase("OneWay")) {
			QaRobot.ClickOnElement("AjOneWay");
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on submit</i></b>");
			...
			QaBrowser.driver.findElement(By.xpath("//div[@id='ArrivalCalendar']/div/span/span/img")).click();
			Thread.sleep(2000);
...
//					QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on MyDatesAreFlexible</i></b>");
			...
			QaRobot.ClickOnElement("AjRoundTrip");
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on submit</i></b>");
...
//					QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on MyDatesAreFlexible</i></b>");
		...
		try {
			...
			QaRobot.ClickOnElement("AjFinalSearchF");
...
//			QaRobot.ScreenshotMethod("FlightTrip", "<b><i>Screenshot for Flight Trip</i></b>");
	...
	public static void hotelTrip(String CityCode, String CityTitle, String CheckInDate, String CheckOutDate,
			String Rooms, String Adult, String Child, String ChildAge, String Nationality, String MoreOptions,
		...
		QaBrowser.driver.findElement(By.xpath("//div[@id='HotelContainer']/form/div/div[2]/div/span/span/img")).click();
		Thread.sleep(2000);
...
//		Thread.sleep(2000);
		...
		if (MoreOptions.equalsIgnoreCase("Yes")) {
			QaRobot.ClickOnElement("MoreOptionsH");
			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on MoreOptions</i></b>");
			Thread.sleep(2000);
		...
		try {
			QaExtentReport.extentScreenshot("Search Page");
			QaRobot.ClickOnElement("AjFinalSearchH");
			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on FinalSearch</i></b>");
...
//		QaBrowser.driver.findElement(By.xpath("//input[@id='txtFlightDepartureDate']")).clear();
		...
		if (date2.before(date1)) {
			...
			while (!(month.equals(Month) && year.equals(Year))) {
				...
				monthYear = QaBrowser.driver.findElement(By.xpath("/html/body/div[8]/div/div[2]/div[1]/div")).getText();
...
//		QaBrowser.driver.findElement(By.xpath("//input[@id='txtFlightDepartureDate']")).clear();
		...
		String monthYear = QaBrowser.driver.findElement(By.xpath("/html/body/div[8]/div/div[2]/div[1]/div")).getText();
		String month = monthYear.split(" ")[0];
		String year = monthYear.split(" ")[1];
		...
		if (date2.before(date1)) {
			...
			QaBrowser.driver
					.findElement(By.xpath("/html/body/div[2]/div/div[1]/div[2]/form[1]/div/div[4]/div/span/span/img"))
					.click();
			Thread.sleep(2000);
//			QaBrowser.driver.findElement(By.xpath("//input[@id='txtFlightArrivalDate']")).clear();

			String monthYear1 = QaBrowser.driver.findElement(By.xpath("/html/body/div[8]/div/div[2]/div[1]/div"))
					.getText();
			...
			if (date3.before(date2)) {
				...
				while (!(month1.equals(Month1) && year1.equals(Year1))) {
					QaBrowser.driver.findElement(By.xpath("/html/body/div[8]/div/div[1]/a[3]")).click();
					monthYear1 = QaBrowser.driver.findElement(By.xpath("/html/body/div[8]/div/div[2]/div[1]/div"))
							.getText();
...
//		QaBrowser.driver.findElement(By.xpath("//input[@id='txtDepartHotelDateInternational']")).clear();
		...
		if (date2.before(date1)) {
			...
			QaBrowser.driver.findElement(By.xpath("//div[@id='HotelContainer']/form/div/div[3]/div/span/span/img"))
					.click();
			Thread.sleep(2000);
