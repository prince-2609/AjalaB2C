...
public class B2cResultPage {
	public static void ResultPageForFlight(String TripType, String ModifySearch, String ChangeTrip, String TripTypeM,
...
//		QaRobot.ScreenshotMethod("BaggegeInformation", "<b><i>Screenshot for Baggege Information</i></b>");
	...
	public static void ResultPageForHotel(String Rooms, String ModifySearch, String ChangeTripLocation,
		...
		if (ModifySearch.equalsIgnoreCase("Yes")) {
			QaRobot.ClickOnElement("AjModifySearchH");
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Modify Search</i></b>");
...
//			QaBrowser.driver.switchTo().window(ParentWindow5);
			...
			QaRobot.ClickOnElement("Room_Book");
...
//		QaBrowser.driver.findElement(By.xpath("//input[@id='MtxtDepartureDate0']")).clear();
		...
		if (Integer.parseInt(Day) > 31) {
			...
			throw new B2cExceptionClass("Invalid Modified date provided " + Day + "-" + Month + "-" + Year);
		}
		...
		if (date2.before(date1)) {
			...
			if (Integer.parseInt(currentMonthNumber) < Integer.parseInt(currentMonthNumber2) && year.equals(Year)) {
				while (!(month.equals(Month) && year.equals(Year))) {
					QaBrowser.driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/a[1]")).click();
					monthYear = QaBrowser.driver.findElement(By.xpath("/html/body/div[4]/div/div[2]/div[1]/div"))
							.getText();
	...
	public static void selectDateInCalendarRoundTrip(String Day, String Month, String Year, String Day1, String Month1,
		...
		if (Integer.parseInt(Day1) > 31) {
			...
			throw new B2cExceptionClass("Invalid Modified date provided " + Day1 + "-" + Month1 + "-" + Year1);
		}
		...
		if (date2.before(date1)) {
			...
			String monthYear1 = QaBrowser.driver.findElement(By.xpath("/html/body/div[4]/div/div[2]/div[1]/div"))
					.getText();
			...
			if (date3.before(date2)) {
				...
				throw new B2cExceptionClass(
						"Invalid Return Modified date provided " + Day1 + "-" + Month1 + "-" + Year1);
			} else {
				while (!(month1.equals(Month1) && year1.equals(Year1))) {
					QaBrowser.driver.findElement(By.xpath("/html/body/div[4]/div/div[1]/a[3]")).click();
					monthYear1 = QaBrowser.driver.findElement(By.xpath("/html/body/div[4]/div/div[2]/div[1]/div"))
							.getText();
