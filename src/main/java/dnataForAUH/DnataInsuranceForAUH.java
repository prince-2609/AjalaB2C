...
public class DnataInsuranceForAUH {
	@DataProvider
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("dnataInsuranceAUH", "FinalTest");
	}
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Select Policy</i></b>");
				...
				DnataResultPage.ResultPageForInsurance(TravellerType, SelectPax, PaxDOB, ModifySearch, ChangeTrip,
						...
						BenefitsNo, Benefits, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode,
						PaymentType);
			}
