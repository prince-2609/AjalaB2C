...
public class DnataResultPage {
	public static void ResultPageForFlight(String TravellerType, String TripType, String adult, String child,
			String infant, String Supplier, String ModifySearch, String ChangeTrip, String TripTypeM,
			...
			String childM, String infantM, String ChangeClass, String ClassM, String ChangeAirline, String PANumberM,
			String PreferredAirlineSelectM, String ShowDirectFlightM, String SupplierChange, String SupplierM,
			String Applyfilter, String FareType, String AirLine, String Resultpagestep, String QuoteTitle,
...
//				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Modified Show Direct Flight</i></b>");
			...
			if (SupplierChange.equalsIgnoreCase("Yes")) {
				List<WebElement> listOfAirline1 = QaBrowser.driver.findElements(
						By.xpath("//div[@id='Return']/div/div/div[1]/div[5]/div/div[2]/div/div/div/label/span"));
				...
				List<WebElement> listOfAirline = QaBrowser.driver.findElements(
						By.xpath("//div[@id='Return']/div/div/div[1]/div[5]/div/div[2]/div/div/div/label/span"));
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Add To Cart</i></b>");
			...
			QaRobot.ClickOnElement("YourItineraryF");
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Pass Remark Title</i></b>");
			...
			QaRobot.ClickOnElement("SendQuoteF");
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on Approve Button</i></b>");
			...
			if(TravellerType.equalsIgnoreCase("Individual")) {
				...
				QaRobot.ClickOnElement("SelectItineraryD");
			}
...
//			}
			...
			if (TravellerType.equalsIgnoreCase("Individual")) {
				DnataCheckoutPage.individualforFlight(TravellerType, TripType, adult, child, infant, ModifySearch,
						...
						Checkoutpagestep, PaymentMode, PaymentType);
			} else if (TravellerType.equalsIgnoreCase("Dependent")) {
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Book Now</i></b>");
	...
	public static void ResultPageForHotel(String TravellerType, String Rooms, String Adult, String Child,
			String Supplier, String ModifySearch, String ChangeTripLocation, String CityCodeM, String CityTitleM,
			String ChangeTripDate, String CheckInDateM, String CheckOutDateM, String ChangeRooms, String RoomsM,
			String AdultM, String ChildM, String ChildAgeM, String ChangeStarRating, String StarRatingM,
			String SupplierChange, String MSupplier, String Resultpagestep, String QuoteTitle, String QuoteRemark,
						...
						for (String chd : childcount) {
							...
							for (int i = 1; i <= chdcount; i++) {
								...
								if (ac1 > 17) {
									...
									WebElement childrenage = QaBrowser.driver.findElement(
											By.xpath("//select[@id='htl" + chdcount + "child" + i + "age']"));
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Modified Search</i></b>");
		...
		if (QaBrowser.driver.findElement(By.xpath(
				"//div[@id='trErrHeading']/h1[contains(text(),'                                    No Results Found')]"))
				.isDisplayed()) {
			String a = QaBrowser.driver.findElement(By.xpath(
					"/html/body/div[1]/div[1]/div/div[2]/section[1]/div/div[3]/div[2]/div[5]/div/div/h1/text()')]"))
					.getText();
...
//				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Send Quote</i></b>");
				...
				String getT = QaBrowser.driver
						.findElement(By.xpath("//div[@id='FlightQuotationModal']/div/div/div[2]/p")).getText();
				System.out.println(getT);
				String getTxt1[] = getT.split(" ");
				String number = getTxt1[11];
				System.out.println(number);
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on Final Book Button</i></b>");
				...
				DnataCheckoutPage.individualforHotel(TravellerType, Adult, Child, ModifySearch, ChangeRooms, AdultM,
						ChildM, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
			}
				...
				if(Supplier.equalsIgnoreCase("YALAGO")) {
					QaRobot.ClickOnElement("BookH");
				}else if(Supplier.equalsIgnoreCase("SABRE")) {
					QaRobot.ClickOnElement("BookH1");
				}
//				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Book</i></b>");
	...
	public static void ResultPageForInsurance(String TravellerType, String SelectPax, String PaxDOB,
			String ModifySearch, String ChangeTrip, String OriginCityCodeM, String OriginLocationM,
			String DestinationCityCodeM, String DestinationLocationM, String ChangeTripDate, String StartDateM,
			String EndDateM, String ChangePolicyFor, String PolicyForM, String SelectPaxM, String PaxDOBM,
			String ChangeFOPType, String FOPTypeM, String BenefitsNo, String Benefits, String Resultpagestep,
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Modify Search</i></b>");
			...
			if (ChangeTrip.equalsIgnoreCase("Yes")) {
				...
				TestBase.listofautosuggestion4(By.xpath("//div[@id='divIDepartureCity']/p"), OriginCityCodeM,
						OriginLocationM, By.xpath("//input[@id='txtINSDepartureCity']"));
				QaExtentReport.test.log(Status.INFO,
						"<b><i>Modified Origin city : </i></b>" + OriginCityCodeM + " - " + OriginLocationM);
				Thread.sleep(2000);

				TestBase.listofautosuggestion4(By.xpath("//div[@id='divIDestinationCity']/p"), DestinationCityCodeM,
						DestinationLocationM, By.xpath("//input[@id='txtINSDestinationCity']"));
				QaExtentReport.test.log(Status.INFO, "<b><i>Modified Destination city : </i></b>" + DestinationCityCodeM
						+ " - " + DestinationLocationM);
				Thread.sleep(2000);
			}
			...
			if (ChangeTripDate.equalsIgnoreCase("Yes")) {
				QaBrowser.driver
						.findElement(By.xpath(
								"//div[@id='Arrival']/div/div/div[1]/div[1]/div[2]/div/div[1]/div/div/span[1]/img"))
						.click();
				Thread.sleep(2000);
			...
			if (ChangePolicyFor.equalsIgnoreCase("Yes")) {
				if (TravellerType.equalsIgnoreCase("Individual")) {
					...
					if (PolicyForM.equalsIgnoreCase("Individual") || PolicyForM.equalsIgnoreCase("Family")) {
						Assert.assertFalse(Integer.parseInt(SelectPaxM) > 9,
								"Invalid Pax Selected " + "-" + SelectPaxM);
						...
						for (int i = 2; i <= Integer.parseInt(SelectPaxM); i++) {
							QaBrowser.driver.findElement(By.xpath("//div[@id='clsDOB_" + i + "']/div/div/span/img"))
									.click();
							Thread.sleep(2000);
						...
						Assert.assertFalse(Integer.parseInt(SelectPaxM) > 2,
								"Invalid Pax Selected " + "-" + SelectPaxM);
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Modified Search</i></b>");
		...
		for (int i = 1; i <= bN; i++) {
			...
			String b = tN[i - 1];
			List<WebElement> listOfCover = QaBrowser.driver
					.findElements(By.xpath("//div[@id='div_020100_WRLDWD_21_0']/div/label"));
		...
		QaRobot.ClickOnElement("FareBreakupIAUH");
//		QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Fare Breakup</i></b>");
		Thread.sleep(5000);
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Fare Close</i></b>");
		...
		if (Resultpagestep.equalsIgnoreCase("Add to Cart") || Resultpagestep.equalsIgnoreCase("Send Quote")) {
			if (Resultpagestep.equalsIgnoreCase("Add to Cart")) {
				QaRobot.ClickOnElement("AddToCartIAUH");
//				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Add To Cart</i></b>");
				Thread.sleep(5000);
				...
				QaRobot.ClickOnElement("YourItineraryI");
//				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Your Itinerary</i></b>");
				Thread.sleep(5000);
//				QaExtentReport.extentScreenshot("Your Itinerary");
			} else if (Resultpagestep.equalsIgnoreCase("Send Quote")) {
				QaRobot.ClickOnElement("SendQuoteRIAUH");
//				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Book Now</i></b>");
				Thread.sleep(5000);
...
//				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Send Quote</i></b>");
			...
			String getT = QaBrowser.driver.findElement(By.xpath("//div[@id='InsQuotationModal']/div/div/div[2]/p"))
					.getText();
//				System.out.println(getT);
			String getTxt1[] = getT.split(" ");
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on Final Book Button</i></b>");
			...
			if (TravellerType.equalsIgnoreCase("Individual")) {
				DnataCheckoutPage.individualforInsurance(TravellerType, SelectPax, PaxDOB, ModifySearch, SelectPaxM,
						PaxDOBM, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
			} else if (TravellerType.equalsIgnoreCase("Dependent")) {
				DnataCheckoutPage.CheckoutForInsuranceDependent(TravellerType, SelectPax, PaxDOB, ModifySearch,
						SelectPaxM, PaxDOBM, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode,
						PaymentType);
			}
		} else if (Resultpagestep.equalsIgnoreCase("Book Now")) {
			QaRobot.ClickOnElement("BookNowRIAUH");
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Book Now</i></b>");
			Thread.sleep(5000);
	...
	public static void ResultPageForFlight_Hotel(String ModifySearch, String ChangeTripLocation, String MarketTypeM,
			String OriginCityCodeM, String OriginLocationM, String DestinationCityCodeM, String DestinationLocationM,
			String ChangeTripDate, String DepartureDateM, String ReturnDateM, String ChangeRooms, String RoomsM,
			String AdultM, String ChildM, String ChildAgeM, String InfantM, String InfantAgeM,
			String MyHotelDiffenrentDateM, String ChangeCheckInM, String ChangeCheckOutM, String ChangeCurrency,
			String CurrencyM, String ChangeClass, String ClassM, String ChangeAirline, String PANumberM,
			String PreferredAirlineSelectM, String ShowDirectFlightM, String Applyfilter, String StarRating,
			String PropertyType, String RateType, String ChooseAnotherFlight, String FlightFilter, String FareType,
			String AirLine) throws Exception {
		Thread.sleep(15000);
		...
		if (ModifySearch.equalsIgnoreCase("Yes")) {
			...
			if (ChangeTripLocation.equalsIgnoreCase("Yes")) {
				TestBase.listofautosuggestion4(By.xpath("//div[@id='dymModifyfromDiv']/p"), OriginCityCodeM,
						OriginLocationM, By.xpath("//input[@id='ctl00_contentMain_ctl00_dymModifyfromText']"));
				QaExtentReport.test.log(Status.INFO,
						"<b><i>Modified Departure city : </i></b>" + OriginCityCodeM + " - " + OriginLocationM);
				Thread.sleep(2000);

				TestBase.listofautosuggestion4(By.xpath("//div[@id='dymModifytoDiv']/p"), DestinationCityCodeM,
						DestinationLocationM, By.xpath("//input[@id='ctl00_contentMain_ctl00_dymModifytoText']"));
				QaExtentReport.test.log(Status.INFO,
			...
			if (ChangeRooms.equalsIgnoreCase("Yes")) {
				...
				if (room > 5) {
					...
					WebElement roomelement = QaBrowser.driver
							.findElement(By.xpath("//select[@id='ctl00_contentMain_ctl00_DymModifySltHtlRooms']"));
					Select selectroom = new Select(roomelement);
					selectroom.selectByValue(RoomsM);
					Thread.sleep(2000);

					for (int i = 1; i <= room; i++) {
						WebElement adultelement = QaBrowser.driver.findElement(
								By.xpath("//select[@id='ctl00_contentMain_ctl00_DymModifySltAdult" + i + "']"));
						Select selectadult = new Select(adultelement);
						selectadult.selectByValue(adultcount[i - 1]);
						Thread.sleep(2000);

						WebElement childelement = QaBrowser.driver.findElement(
								By.xpath("//select[@id='ctl00_contentMain_ctl00_DymModifySltHtlChild" + i + "']"));
						Select selectchild = new Select(childelement);
						selectchild.selectByValue(childcount[i - 1]);
						Thread.sleep(2000);

						WebElement infantelement = QaBrowser.driver.findElement(
								By.xpath("//select[@id='ctl00_contentMain_ctl00_DymModifySltHtlInfant" + i + "']"));
						...
						for (int i = 1; i <= chdcount; i++) {
							...
							if (ac1 > 11) {
								...
								WebElement childrenage = QaBrowser.driver
										.findElement(By.xpath("//select[@id='ctl00_contentMain_ctl00_DymModifyChildAge"
												+ chdcount + "_" + i + "']"));
								Select selectage = new Select(childrenage);
								selectage.selectByValue(ageofchild[i - 1]);
								Thread.sleep(2000);
...
//					}
			...
			if (MyHotelDiffenrentDateM.equalsIgnoreCase("Yes")) {
				...
				QaExtentReport.test.log(Status.INFO,
						"<b><i>Clicked on My Hotel Check in Check out dates different</i></b>");
			...
			if (ChangeCurrency.equalsIgnoreCase("Yes")) {
				QaRobot.selectValueFromDropdown("CurrencyMFH", CurrencyM,
						"<b><i>Select Modified Currency for booking</i></b>");
				Thread.sleep(2000);
			}

			if (ChangeClass.equalsIgnoreCase("Yes")) {
				QaRobot.selectTextByLocator("//select[@id='ctl00_contentMain_ctl00_DymModifyBusclass']", ClassM,
						"<b><i>Select Modified Class for booking</i></b>");
				Thread.sleep(2000);
			}
			...
			if (ChangeAirline.equalsIgnoreCase("Yes")) {
				...
				for (int i = 1; i <= pAS; i++) {
					...
					TestBase.listofautosuggestion1(
							By.xpath("//ul[@class='ui-multiselect-checkboxes ui-helper-reset']/li/label"), b, By.xpath(
									"/html/body/form/div[4]/div[2]/div[2]/section/div[2]/div/div[1]/div[1]/div/div/div[12]/div/div/div/div[1]/input"));
				}
				QaRobot.ClickOnElement("PreferredAirlineMFH");
			}
		...
		if (ChooseAnotherFlight.equalsIgnoreCase("Yes")) {
			...
			if (FlightFilter.equalsIgnoreCase("Yes")) {
				...
				List<WebElement> listOfAirLine = QaBrowser.driver
						.findElements(By.xpath("//div[@id='tdContainerTblAirlines']//li//span"));
...
//		System.out.println(date1);
	...
	public static void selectDateInCalendarFlight_Hotel(String Day, String Month, String Year, String Day1,
		...
		if (date2.before(date1)) {
			...
			List<WebElement> allDates = QaBrowser.driver
					.findElements(By.xpath("/html/body/div[1]/div/div[2]/div[1]/table/tbody/tr/td"));
...
//		System.out.println(date3);
		...
		QaBrowser.driver
				.findElement(
						By.xpath("//div[@id='Arrival']/div/div/div[1]/div[1]/div[2]/div/div[2]/div/div/span[1]/img"))
				.click();
		Thread.sleep(2000);
	...
	public static void selectDateInCalendarFlight_Hotel1(String Day, String Month, String Year, String Day1,
		...
		if (date2.before(date1)) {
			...
			QaBrowser.driver.findElement(By.xpath("//input[@id='ctl00_contentMain_ctl00_DymModifyHotelCheckout']"))
					.clear();
