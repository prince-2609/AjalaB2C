...
public class DnataConfirmPage {
	public static void confirmpageFlight(String TravellerType, String adult, String child, String infant,
...
//		QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on Itenerary</i></b>");
		...
		String getT5 = QaBrowser.driver.findElement(By.xpath(
				"/html/body/form/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[1]/div[3]/table/tbody/tr/td/div[3]/table/tbody/tr/td/table/tbody/tr[2]/td[7]/span"))
				.getText();
...
//		Assert.assertEquals(number3, TotalFare,"Check Total Fare");
		...
		Thread.sleep(3000);
		QaRobot.ClickOnElement("SearchBookingRefFAUH");
		Thread.sleep(8000);
		...
		if (ModifySearch.equalsIgnoreCase("Yes")) {
			if (ChangeTravellers.equalsIgnoreCase("Yes")) {
				...
				for (int i = 1; i <= PaxTotal; i++) {
					String Pax = QaBrowser.driver
							.findElement(By.xpath("//span[@id='MODocument_lblPax" + (i - 1) + "']")).getText();
					String TicketNo = QaBrowser.driver
							.findElement(By.xpath("//span[@id='MODocument_lblTktNo" + (i - 1) + "']")).getText();
					QaExtentReport.test.log(Status.INFO,
							"" + Pax + " " + "<b><i>Ticket No is</i></b>" + " " + TicketNo + "");
				}
			}
		} else {
			if (TravellerType.equalsIgnoreCase("Individual")) {
				...
				String TicketNo = QaBrowser.driver.findElement(By.xpath("//span[@id='MODocument_lblTktNo0']"))
						.getText();
				QaExtentReport.test.log(Status.INFO,
						"" + Pax + " " + "<b><i>Ticket No is</i></b>" + " " + TicketNo + "");
			} else {
...
//		QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
	...
	public static void confirmpageHotel(String Adult, String Child, String ModifySearch, String ChangeRooms,
			String AdultM, String ChildM) throws Exception {
		WebElement getT = QaBrowser.driver
				.findElement(By.xpath("/html/body/div/form/div[4]/div/div/section/div[2]/div/div/div[1]/h2"));
		...
		JavascriptExecutor m2 = (JavascriptExecutor) QaBrowser.driver;
		m2.executeScript("window.scrollBy(0,500)", "");

		String getT7 = QaBrowser.driver
				.findElement(
						By.xpath("/html/body/div/form/div[4]/div/div/section/div[2]/div/div/div[5]/div[5]/div/div[2]"))
				.getText();
		String getT8[] = getT7.split(" ");
		String TotalFare = getT8[1];
...
//		QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on Fare Breakdown</i></b>");
		...
		String getT6 = QaBrowser.driver.findElement(By.xpath(
				"/html/body/form/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[1]/div[3]/table/tbody/tr/td/div[4]/table/tbody/tr[2]/td/table/tbody/tr[3]/td[2]/span"))
				.getText();
		String getTxt7[] = getT6.split(" ");
		String number3 = getTxt7[0];
		Assert.assertEquals(number3, TotalFare, "Check Total Fare");
...
//					for (int i = 1; i <= PaxTotal; i++)
//					{ 
					String VoucherNo = QaBrowser.driver.findElement(By.xpath(
							"/html/body/form/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[1]/div[3]/table/tbody/tr/td/div[6]/table[1]/tbody/tr/td/table[3]/tbody/tr[2]/td/table/tbody/tr[2]/td[6]/span"))
							.getText();
					QaExtentReport.test.log(Status.INFO, "<b><i>Voucher No is</i></b>" + " " + VoucherNo + "");

					WebElement VoucherView = QaBrowser.driver
							.findElement(By.xpath("//select[@id='MODocument$btnView1_00']"));
...
//				{ 
				...
				WebElement VoucherView = QaBrowser.driver
						.findElement(By.xpath("//select[@id='MODocument_btnView1_00']"));
				Select selectOption = new Select(VoucherView);
				selectOption.selectByValue("VIEW");
				Thread.sleep(5000);
...
//				}
	...
	public static void confirmpageFulfilmentHotel(String Adult, String Child, String ModifySearch, String ChangeRooms,
			String AdultM, String ChildM) throws Exception {
		WebElement getT = QaBrowser.driver
				.findElement(By.xpath("/html/body/form/div[3]/div[2]/div/section/div[2]/div/div/div[1]/h2"));
		String getTxt = getT.getText();
		String getTxt1[] = getTxt.split(" ");
		String number = getTxt1[1];
		QaExtentReport.test.log(Status.INFO, "<b><i>Booking id is </i></b>" + number);
		...
		String getT7 = QaBrowser.driver
				.findElement(
						By.xpath("/html/body/form/div[3]/div[2]/div/section/div[2]/div/div/div[5]/div[5]/div/div[2]"))
				.getText();
		String getT8[] = getT7.split(" ");
		String TotalFare = getT8[1];
	...
	public static void confirmpageInsurance(String TravellerType) throws Exception {
		...
		String getT1 = QaBrowser.driver
				.findElement(By.xpath(
						"//div[@id='ctl00_tdContent']/section/div[2]/div/div/div[3]/div/div[1]/div[2]/p/span[1]"))
				.getText();
		...
		WebElement getT2 = QaBrowser.driver.findElement(
				By.xpath("//div[@id='ctl00_tdContent']/section/div[2]/div/div/div[3]/div/div[1]/div[2]/p/span[2]"));
		String getTxt4 = getT2.getText();
		String getTxt5[] = getTxt4.split(" ");
		String number2 = getTxt5[2];
...
//		String getT7 = QaBrowser.driver
//				.findElement(By.xpath("/html/body/div/form/div[4]/div/div/section/div[2]/div/div/div[5]/div[3]/div[2]"))
//				.getText();
//		String getT8[] = getT7.split(" ");
//		String TotalFare = getT8[1];
//		QaExtentReport.extentScreenshot("Confirm Page1");
...
//			{
		if (TravellerType.equalsIgnoreCase("Individual")) {
			String VoucherNo = QaBrowser.driver.findElement(By.xpath("//span[@id='MODocument_lblIVoucherNo00']"))
					.getText();
			QaExtentReport.test.log(Status.INFO, "<b><i>Voucher No is</i></b>" + " " + VoucherNo + "");
		} else {
//					String[] adt = adult.split(",");
