...
public class DnataFlightForAUH {
	@DataProvider
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("dnataFlightAUH", "FinalTest");
	}

	@Test(dataProvider = "getexceldata")
	public static void dnataforflight(String TestCaseId, String TestCaseType, String TestScenario, String Source,
			String URL, String CompanyCode, String UserName, String Password, String SearchCorporateTraveller,
			String TravelType, String TravellerType, String TripType, String OriginCityCode, String OriginLocation,
			String DestinationCityCode, String DestinationLocation, String DepartureDate, String ReturnDate,
			String adult, String child, String infant, String Class, String PreAirline, String PANumber,
			String PreferredAirlineSelect, String FOPType, String ShowDirectFlight, String Supplier,
			String ModifySearch, String ChangeTrip, String TripTypeM, String OriginCityCodeM, String OriginLocationM,
			...
			String ChangeClass, String ClassM, String ChangeAirline, String PANumberM, String PreferredAirlineSelectM,
			String ShowDirectFlightM, String SupplierChange, String SupplierM, String Applyfilter, String FareType,
			String AirLine, String Resultpagestep, String QuoteTitle, String QuoteRemark, String Checkoutpagestep,
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Select Policy</i></b>");
				...
				DnataTripType.flightTriptype(TravellerType, TripType, OriginCityCode, OriginLocation,
						DestinationCityCode, DestinationLocation, DepartureDate, ReturnDate, adult, child, infant,
						Class, PreAirline, PANumber, PreferredAirlineSelect, FOPType, ShowDirectFlight, Supplier);

				DnataResultPage.ResultPageForFlight(TravellerType, TripType, adult, child, infant, Supplier,
						ModifySearch, ChangeTrip, TripTypeM, OriginCityCodeM, OriginLocationM, DestinationCityCodeM,
						DestinationLocationM, ChangeTripDate, DepartureDateM, ReturnDateM, ChangeTravellers, adultM,
						childM, infantM, ChangeClass, ClassM, ChangeAirline, PANumberM, PreferredAirlineSelectM,
						ShowDirectFlightM, SupplierChange, SupplierM, Applyfilter, FareType, AirLine, Resultpagestep,
