...
public class DnataHotelForAUH {
	@DataProvider
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("dnataHotelAUH", "FinalTest");
	}

	@Test(dataProvider = "getexceldata")

	public static void dnataforhotel(String TestCaseId, String TestCaseType, String TestScenario, String Source,
			String URL, String CompanyCode, String UserName, String Password, String SearchCorporateTraveller,
			String TravelType, String TravellerType, String CityCode, String CityTitle, String CheckInDate,
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Select Policy</i></b>");
				...
				DnataTripType.hotelTrip(TravellerType, CityCode, CityTitle, CheckInDate, CheckOutDate, Rooms, Adult,
						Child, ChildAge, FOPType, Supplier);

				DnataResultPage.ResultPageForHotel(TravellerType, Rooms, Adult, Child, Supplier, ModifySearch,
						ChangeTripLocation, CityCodeM, CityTitleM, ChangeTripDate, CheckInDateM, CheckOutDateM,
						ChangeRooms, RoomsM, AdultM, ChildM, ChildAgeM, ChangeStarRating, StarRatingM, SupplierChange,
						MSupplier, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
			}
