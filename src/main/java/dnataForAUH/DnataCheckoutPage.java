...
public class DnataCheckoutPage {
	public static void individualforFlight(String TravellerType, String TripType, String adult, String child,
			String infant, String ModifySearch, String ChangeTravellers, String adultM, String childM, String infantM,
			String Resultpagestep, String QuoteTitle, String QuoteRemark, String Checkoutpagestep, String PaymentMode,
...
//			QaRobot.PassValue("ArrangerEmail","Test"); 
			...
			bookForFlight(TravellerType, TripType, adult, child, infant, ModifySearch, ChangeTravellers, adultM, childM,
					infantM, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
		} else if (TravellerType.equalsIgnoreCase("Dependent")) {
			CheckoutForFlightDependent(TravellerType, TripType, adult, child, infant, ModifySearch, ChangeTravellers,
					adultM, childM, infantM, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode,
					PaymentType);
		}
	}

	public static void CheckoutForFlightDependent(String TravellerType, String TripType, String adult, String child,
			String infant, String ModifySearch, String ChangeTravellers, String adultM, String childM, String infantM,
			String Resultpagestep, String QuoteTitle, String QuoteRemark, String Checkoutpagestep, String PaymentMode,
			String PaymentType) throws Exception {
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>clicked on Associate button</i></b>");
		...
		WebElement MoreDetails = QaBrowser.driver
				.findElement(By.xpath("//div[@id='ctl00_contentMain_incartDiv']/div[7]/div[3]/div[10]/ul/li[1]/a"));
		JavascriptExecutor js3 = (JavascriptExecutor) QaBrowser.driver;
		js3.executeScript("arguments[0].click()", MoreDetails);
//		QaExtentReport.test.log(Status.INFO, "<b><i>Click on More Details</i></b>");
		Thread.sleep(5000);
		...
		WebElement MoreDetailsClose = QaBrowser.driver
				.findElement(By.xpath("//body[@id='ctl00_btnMstr']/div/div/div/a"));
		JavascriptExecutor js4 = (JavascriptExecutor) QaBrowser.driver;
		js4.executeScript("arguments[0].click()", MoreDetailsClose);
//		QaExtentReport.test.log(Status.INFO, "<b><i>Click on More Details Close</i></b>");
		Thread.sleep(5000);
		...
		WebElement FareBreakup = QaBrowser.driver
				.findElement(By.xpath("//div[@id='ctl00_contentMain_incartDiv']/div[7]/div[3]/div[10]/ul/li[2]/a"));
		JavascriptExecutor js2 = (JavascriptExecutor) QaBrowser.driver;
		js2.executeScript("arguments[0].click()", FareBreakup);
//		QaExtentReport.test.log(Status.INFO, "<b><i>Click on Fare Breakup</i></b>");
		Thread.sleep(2000);
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>Click on Fare Breakup Close</i></b>");
		...
		bookForFlightDependent(TravellerType, TripType, adult, child, infant, ModifySearch, ChangeTravellers, adultM,
				childM, infantM, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
	}

	public static void CheckoutForHotelDependent(String Adult, String Child, String ModifySearch, String ChangeRooms,
			String AdultM, String ChildM, String Resultpagestep, String QuoteTitle, String QuoteRemark,
			String Checkoutpagestep, String PaymentMode, String PaymentType) throws Exception {
		String ParentWindow = QaBrowser.driver.getWindowHandle();

//		if (QaBrowser.driver.findElement(By.xpath(
//				"//div/span/span[contains(text(),'The hotel you have selected is no more available now!!  Kindly try another hotel room.')]"))
//				.isDisplayed()) {
//			QaExtentReport.test.log(Status.FAIL,
//					"<b><i>The hotel you have selected is no more available now!!  Kindly try another hotel room.</i></b>");
//			throw new Exception(
//					"The hotel you have selected is no more available now!!  Kindly try another hotel room.");
//		} else {
		QaRobot.ClickOnElement("dept_AssociatePax");
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Associate pax</i></b>");
		Thread.sleep(3000);
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>clicked on Associate button</i></b>");
		...
		WebElement FareBreakup = QaBrowser.driver
				.findElement(By.xpath("//div[@id='ctl00_contentMain_incartDiv']/div[7]/div[4]/ul/li/a"));
		JavascriptExecutor js2 = (JavascriptExecutor) QaBrowser.driver;
		js2.executeScript("arguments[0].click()", FareBreakup);
//			QaExtentReport.test.log(Status.INFO, "<b><i>Click on Fare Breakup</i></b>");
		Thread.sleep(3000);
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Click on Fare Breakup Close</i></b>");
		...
		bookForHotelDependent(Adult, Child, ModifySearch, ChangeRooms, AdultM, ChildM, Resultpagestep, QuoteTitle,
				QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
//		}
	}
	...
	public static void selectDependentPax(String adult, String child, String infant) {
		...
		for (int i = 1; i < adt; i++) {
			QaBrowser.driver.findElement(By.xpath("//input[@id='rptPaxDetails_ctl01_rptDetails_ctl0" + i + "_chk']"))
					.click();
//			WebElement AFFNumber = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='rptPaxDetails_ctl01_rptDetails_ctl0" + i + "_DDLFFNumber']"));
//			Select select = new Select(AFFNumber);
//			select.selectByIndex(1);

			WebElement ADocumentNo = QaBrowser.driver
					.findElement(By.xpath("//select[@id='rptPaxDetails_ctl01_rptDetails_ctl0" + i + "_ddlDocNumber']"));
		...
		for (int i = 1; i <= chd; i++) {
			QaBrowser.driver.findElement(By.xpath("//input[@id='rptPaxDetails_ctl02_rptDetails_ctl0" + i + "_chk']"))
					.click();
//			WebElement CFFNumber = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='rptPaxDetails_ctl02_rptDetails_ctl0" + i + "_DDLFFNumber']"));
//			Select select = new Select(CFFNumber);
//			select.selectByIndex(1);

			WebElement CDocumentNo = QaBrowser.driver
					.findElement(By.xpath("//select[@id='rptPaxDetails_ctl02_rptDetails_ctl0" + i + "_ddlDocNumber']"));
...
//			select.selectByIndex(1);
			...
			WebElement CDocumentNo = QaBrowser.driver
					.findElement(By.xpath("//select[@id='rptPaxDetails_ctl03_rptDetails_ctl0" + i + "_ddlDocNumber']"));
			Select select1 = new Select(CDocumentNo);
			select1.selectByIndex(1);
		}
	}
...
//			select.selectByIndex(1);
	...
	public static void selectDependentPaxInsurance(String SelectPax, String PaxDOB, String ModifySearch,
			String PaxDOBM) {
		...
		for (int i = 1; i < pax; i++) {
			if (ModifySearch.equalsIgnoreCase("Yes")) {
				...
				LocalDate date1 = LocalDate.of(Integer.parseInt(Year1), Integer.parseInt(currentMonthNumber1),
						Integer.parseInt(Date1));
				LocalDate today1 = LocalDate.now();

				if (date1.isBefore(today1.minusYears(12))) {
					QaBrowser.driver
							.findElement(By.xpath("//input[@id='rptPaxDetails_ctl01_rptDetails_ctl0" + i + "_chk']"))
							.click();
					WebElement AFFNumber = QaBrowser.driver.findElement(
							By.xpath("//select[@id='rptPaxDetails_ctl01_rptDetails_ctl0" + i + "_DDLFFNumber']"));
					Select select = new Select(AFFNumber);
					select.selectByIndex(1);

					WebElement ADocumentNo = QaBrowser.driver.findElement(
							By.xpath("//select[@id='rptPaxDetails_ctl01_rptDetails_ctl0" + i + "_ddlDocNumber']"));
					Select select1 = new Select(ADocumentNo);
					select1.selectByIndex(1);
				} else if (date1.isBefore(today1.minusYears(2)) && date1.isAfter(today1.minusYears(12))) {
					QaBrowser.driver
							.findElement(By.xpath("//input[@id='rptPaxDetails_ctl02_rptDetails_ctl0" + i + "_chk']"))
							.click();
					WebElement CFFNumber = QaBrowser.driver.findElement(
							By.xpath("//select[@id='rptPaxDetails_ctl02_rptDetails_ctl0" + i + "_DDLFFNumber']"));
					Select select = new Select(CFFNumber);
					select.selectByIndex(1);

					WebElement CDocumentNo = QaBrowser.driver.findElement(
							By.xpath("//select[@id='rptPaxDetails_ctl02_rptDetails_ctl0" + i + "_ddlDocNumber']"));
					Select select1 = new Select(CDocumentNo);
					select1.selectByIndex(1);
				} else if (date1.isAfter(today1.minusYears(2))) {
					QaBrowser.driver
							.findElement(By.xpath("//input[@id='rptPaxDetails_ctl03_rptDetails_ctl0" + i + "_chk']"))
							.click();

					WebElement CDocumentNo = QaBrowser.driver.findElement(
							By.xpath("//select[@id='rptPaxDetails_ctl03_rptDetails_ctl0" + i + "_ddlDocNumber']"));
					Select select1 = new Select(CDocumentNo);
					select1.selectByIndex(1);
				}
...
//					select.selectByIndex(1);
	...
	public static void selectDependentPriorityInsurance(String SelectPax, String PaxDOB, String ModifySearch,
			String PaxDOBM) {
		int pax = Integer.parseInt(SelectPax);
		for (int i = 1; i < pax; i++) {
			if (ModifySearch.equalsIgnoreCase("Yes")) {
	...
	public static void bookForFlight(String TravellerType, String TripType, String adult, String child, String infant,
			String ModifySearch, String ChangeTravellers, String adultM, String childM, String infantM,
			String QuoteTitle, String QuoteRemark, String Checkoutpagestep, String PaymentMode, String PaymentType)
			throws Exception {
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
			...
			DnataPaymentPage.individualForFlight(PaymentMode, PaymentType);

			DnataConfirmPage.confirmpageFlight(TravellerType, adult, child, infant, ModifySearch, ChangeTravellers,
					adultM, childM, infantM);
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on BookAndQuote Button</i></b>");
			...
			DnataConfirmPage.confirmpageFlightwithBookingQueue(TravellerType, adult, child, infant, ModifySearch,
					ChangeTravellers, adultM, childM, infantM, PaymentMode, PaymentType);
		} else if (Checkoutpagestep.equalsIgnoreCase("Fulfilment")) {
			QaRobot.PassValue("DestinationPhoeF", "9863647257");
			int inf = Integer.parseInt(infant);
			for (int i = 1; i <= inf; i++) {
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
	...
	public static void individualforHotel(String TravellerType, String Adult, String Child, String ModifySearch,
			String ChangeRooms, String AdultM, String ChildM, String Resultpagestep, String QuoteTitle,
			String QuoteRemark, String Checkoutpagestep, String PaymentMode, String PaymentType) throws Exception {
		if (TravellerType.equalsIgnoreCase("Individual")) {
			QaExtentReport.extentScreenshot("Checkout Page");
...
//			WebElement ele1 = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='ctl00_contentMain_CostCenterDDLH']"));
//			Select s11 = new Select(ele1);
//			s11.selectByIndex(1);
//
//			WebElement ele2 = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='ctl00_contentMain_CorporateDivisionDDLH']"));
//			Select s22 = new Select(ele2);
//			s22.selectByIndex(1);
//
//			WebElement ele3 = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture85']"));
//			Select s33 = new Select(ele3);
//			s33.selectByIndex(1);
//
//			WebElement ele44 = QaBrowser.driver
...
//			QaExtentReport.extentScreenshot("Checkout page");
			...
			bookForHotel(Adult, Child, ModifySearch, ChangeRooms, AdultM, ChildM, Resultpagestep, QuoteTitle,
					QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
		} else if (TravellerType.equalsIgnoreCase("Dependent")) {
			CheckoutForHotelDependent(Adult, Child, ModifySearch, ChangeRooms, AdultM, ChildM, Resultpagestep,
					QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
		}
	}

	public static void bookForHotel(String Adult, String Child, String ModifySearch, String ChangeRooms, String AdultM,
			String ChildM, String Resultpagestep, String QuoteTitle, String QuoteRemark, String Checkoutpagestep,
			String PaymentMode, String PaymentType) throws Exception {
		if (Checkoutpagestep.equalsIgnoreCase("Quote")) {
...
//			if (QaBrowser.driver
//					.findElement(By.xpath("//div[contains(text(),'Selected hotel room is no longer available or the "
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
			...
			DnataPaymentPage.individualForHotel(PaymentMode, PaymentType);
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
	...
	public static void bookForHotelDependent(String Adult, String Child, String ModifySearch, String ChangeRooms,
			String AdultM, String ChildM, String Resultpagestep, String QuoteTitle, String QuoteRemark,
			String Checkoutpagestep, String PaymentMode, String PaymentType) throws Exception {
		if (Checkoutpagestep.equalsIgnoreCase("Quote")) {
			QaRobot.ClickOnElement("QuoteH");
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
	...
	public static void individualforInsurance(String TravellerType, String SelectPax, String PaxDOB,
			String ModifySearch, String SelectPaxM, String PaxDOBM, String Resultpagestep, String QuoteTitle,
			String QuoteRemark, String Checkoutpagestep, String PaymentMode, String PaymentType) throws Exception {
		if (TravellerType.equalsIgnoreCase("Individual")) {
			Thread.sleep(7000);
...
//					.findElement(By.xpath("//select[@id='ctl00_contentMain_CostCenterDDL']"));
//			Select s1 = new Select(element1);
//			s1.selectByIndex(1);
//
...
//			WebElement element3 = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture86']"));
//			Select s3 = new Select(element3);
//			s3.selectByIndex(1);
//
//			WebElement element4 = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture127']"));
//			Select s4 = new Select(element4);
//			s4.selectByIndex(1);
//
//			WebElement element5 = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture128']"));
//			Select s5 = new Select(element5);
//			s5.selectByIndex(1);
//
//			WebElement element6 = QaBrowser.driver
//					.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture126']"));
//			Select s6 = new Select(element6);
//			s6.selectByIndex(1);
//
...
//				QaExtentReport.test.log(Status.INFO, "<b><i>Pass Remark Title</i></b>");
				...
				WebElement SendQuote = QaBrowser.driver.findElement(
						By.xpath("/html/body/div/div/div[2]/div/div[2]/div[2]/div/div/div/div[5]/div/a[1]"));
				JavascriptExecutor js1 = (JavascriptExecutor) QaBrowser.driver;
				js1.executeScript("arguments[0].click()", SendQuote);
//				QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Send Quote</i></b>");
				Thread.sleep(5000);
...
//				WebElement elemen1 = QaBrowser.driver
//						.findElement(By.xpath("//select[@id='ctl00_contentMain_CostCenterDDL']"));
//				Select s10 = new Select(elemen1);
//				s10.selectByIndex(1);
//
//				WebElement elemen2 = QaBrowser.driver
//						.findElement(By.xpath("//select[@id='ctl00_contentMain_CorporateDivisionDDL']"));
...
//				WebElement elemen3 = QaBrowser.driver
//						.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture86']"));
//				Select s30 = new Select(elemen3);
//				s30.selectByIndex(1);
//
//				WebElement elemen4 = QaBrowser.driver
//						.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture127']"));
//				Select s40 = new Select(elemen4);
//				s40.selectByIndex(1);
//
//				WebElement elemen5 = QaBrowser.driver
//						.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture128']"));
//				Select s50 = new Select(elemen5);
//				s50.selectByIndex(1);
//
//				WebElement elemen6 = QaBrowser.driver
//						.findElement(By.xpath("//select[@id='ctl00_contentMain_dynamicdatacapture126']"));
...
//				QaRobot.PassValue("ArrangerEmail", "Test");
			...
			DnataPaymentPage.individualForInsurance(PaymentMode, PaymentType);

			DnataConfirmPage.confirmpageInsurance(TravellerType);
		} else if (TravellerType.equalsIgnoreCase("Dependent")) {
			CheckoutForInsuranceDependent(TravellerType, SelectPax, PaxDOB, ModifySearch, SelectPaxM, PaxDOBM,
					Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
		}
	}

	public static void CheckoutForInsuranceDependent(String TravellerType, String SelectPax, String PaxDOB,
			String ModifySearch, String SelectPaxM, String PaxDOBM, String Resultpagestep, String QuoteTitle,
			String QuoteRemark, String Checkoutpagestep, String PaymentMode, String PaymentType) throws Exception {
		QaRobot.PassValue("Street", "720");
		QaRobot.PassValue("Address", "Gurgaon");
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on add to list button</i></b>");
			...
			WebElement webelement = QaBrowser.driver
					.findElement(By.xpath("//select[@id='rptSelectionList_ctl01_rptSelection_ctl01_ddlPriority']"));
			Select select = new Select(webelement);
			select.selectByIndex(1);
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>clicked on Associate button</i></b>");
		...
		bookForInsuranceDependent(TravellerType, QuoteTitle, QuoteRemark, Checkoutpagestep, PaymentMode, PaymentType);
	}

	public static void bookForInsuranceDependent(String TravellerType, String QuoteTitle, String QuoteRemark,
			String Checkoutpagestep, String PaymentMode, String PaymentType) throws Exception {
		if (Checkoutpagestep.equalsIgnoreCase("Quote")) {
			QaRobot.ClickOnElement("QuoteRI");
			Thread.sleep(7000);
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Pass Remark Title</i></b>");
			...
			WebElement SendQuote = QaBrowser.driver
					.findElement(By.xpath("/html/body/div/div/div[2]/div/div[2]/div[2]/div/div/div/div[5]/div/a[1]"));
			JavascriptExecutor js1 = (JavascriptExecutor) QaBrowser.driver;
			js1.executeScript("arguments[0].click()", SendQuote);
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Send Quote</i></b>");
			Thread.sleep(5000);
...
//			QaRobot.PassValue("ArrangerEmail", "Test");
	...
	public static void AdultCheckoutForFlight(String adult, String AdultTitle, String AdultName, String AdultDate,
